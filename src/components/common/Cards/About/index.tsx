const AboutCard = ({
  ...
  return (
    <div
      className={`col-span-2 lg:col-span-1 odd:lg:col-start-1 even:lg:col-start-2 ${rowStart} space-y-3 lg:space-y-7 bg-white/20 dark:bg-gray-600/20 backdrop-blur-md rounded-xl border-2 border-white/30 dark:border-gray-600/30 p-6 lg:p-16`}
    >
