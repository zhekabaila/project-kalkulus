    ...
    >
      <div className="relative size-full">
        ...
        <div className="flex flex-col items-center justify-center bg-gray-500/10 backdrop-blur-lg rounded-2xl size-full border-2 border-gray-500/20">
          <h1 className="text-center font-medium text-7xl leading-tight dark:text-sun">
            Selamat Datang Di <br />
            <span className="text-blue-500 dark:text-jeruk">Website</span> Kami!
          </h1>
          <p className="text-base text-center mt-8 dark:text-sun max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-x-6 mt-6">
            <Link
              href="#tentang"
              className="flex items-center gap-x-3 bg-blue-500 dark:bg-jeruk border border-blue-500 dark:border-jeruk px-5 py-3 rounded-full"
            >
